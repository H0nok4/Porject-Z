...
namespace Main
{
    public class MainBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(UI_ComThingDes.URL, typeof(UI_ComThingDes));
            UIObjectFactory.SetPackageItemExtension(UI_ComDesignPanel.URL, typeof(UI_ComDesignPanel));
